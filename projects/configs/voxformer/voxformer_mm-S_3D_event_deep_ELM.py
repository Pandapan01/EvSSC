work_dir = 'result/voxformer-S_deform3D_ev_rgb_elm'
_base_ = [
...
model = dict(
    ...
    pts_bbox_head=dict(
       ...
       cross_transformer=dict(
           type='PerceptionTransformer2deep',
       ...
       self_transformer=dict(
        ...
        positional_encoding_img=dict(
            type='LearnedPositionalEncoding',
            num_feats=_pos_dim_,
            row_num_embed=512,
            col_num_embed=512,
        ),
       positional_encoding_ev=dict(
           type='LearnedPositionalEncoding',
           num_feats=_pos_dim_,
           row_num_embed=512,
           col_num_embed=512,
...
dataset_type = 'SemanticKittiDatasetStage2_multimodal'
data_root = './kitti/'
