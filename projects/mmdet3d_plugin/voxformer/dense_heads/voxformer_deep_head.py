...
class VoxFormerHead_deep(nn.Module):
    def __init__(
        self,
        *args,
        bev_h,
    ...
    def save_pred(self, img_metas, y_pred):
        ...
        # save predictions
        pred_folder = os.path.join("./voxformer_test_pre", "sequences", img_metas[0]['sequence_id'], "predictions")
        if not os.path.exists(pred_folder):
            os.makedirs(pred_folder)
        npy_path = os.path.join(pred_folder, f"{img_metas[0]['frame_id']}.npy")
